...
//                                }
                        ...
                        <ul class="pagination" id="ul" style="disply:inline">
            ...
            <div class="col-md-5" id="rightdiv">
                <div class="row row-equal animated fadeIn">
                            ...
                            <div class="baraja-demo" >
                                <ul id="baraja-el" class="baraja-container">
                                    <li>
                                        ...
                                        <button type="button" id="rbfbtnsend" class="btn btn-link" style="color:white;margin-left:11%;" onclick='addLine(1)'><i class="fa fa-reply"></i>&nbsp;将预测发送到图表</button>
                                    ...
                                    <li>
										...
										<button type="button" id="graybtnsend" class="btn btn-link" style="color:white;margin-left:11%" onclick='addLine(2)'><i class="fa fa-reply"></i>&nbsp;将预测发送到图表</button>
                    ...
                    <div class="col-md-7" style="padding-top: 0px">
						...
						<div style="background-color: #69BC37; color: white;height: 20px;text-align: center;font-size: 14px;">
                            <span onclick="showAnyQuantScore()" style="cursor: pointer"> <i class="fa  fa-angle-double-down"></i>股票得分 </span>
                        </div>
                        ...
                        <div id="anyquantscore" class="card card-inverse" style="background-color: rgba(105,188,55,0.95);display: none;z-index: 999;position: absolute;margin-right: 7px" >
                                ...
                                <div class="card-block">
                                    <h4 style="text-align: center">AnyQuant股票得分</h4>
                                    <h4 id="anyquantscorenum" style="text-align: center">对大盘不作评分</h4>
...
initBenchmarkBanner();        
                ...
                <div id="sliderforbenchmark" class="benchmarkbanner row row-equal  animated fadeIn " style="margin-left: 1px;">
                    <ul>
                        ...
                        <p style="font-size: 12px;text-align: center;">(热门程度按成交量排名)</p>
                        <div id  = "tablecard" >
						<table class = "industrytable">
						 <thead>
								<tr>
                        ...
                        <div  class="col-md-4" style="padding-top: 1px">
                            <div class="card card-inverse card-warning">
                                <div class="card-block">
                                    ...
                                    <div class="h4 m-b-0" id="strategyvalue2">¥0</div>
                        ...
                        <div  class="col-md-4" style="padding-top: 1px">
                            <div class="card card-inverse card-primary" style="background-color: #00a67c">
                                <div class="card-block">
                                    ...
                                    <div class="h4 m-b-0" id="strategyvalue3">99</div>
		...
		<div id="sliderforshare" class="banner row row-equal  animated fadeIn " style="margin-left: 1px;display: none">
                    <ul>
                        <li>
                            ...
                            <div class="row row-equal  animated fadeIn">
                                ...
                                <div class="col-md-7" style="padding-top: 5px">
                                    <input type="text" id="range_indate" name="example_name" value="">
                                </div>
                        ...
                        <li>
                            <h6 style="text-align: center;padding-top: 5px;font-weight: bold;">今日分析</h6>
                            <div class="row row-equal">
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-block text-xs-center">
                                            <div class="text-muted small  font-weight-bold" style="text-align:center">指标分析</div>
                                            <div id="advice1">advice</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-block text-xs-center">
                                            <div class="text-muted small  font-weight-bold" style="text-align:center">策略总结</div>
                                            <div id="advice3">advice</div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <li>
                            <h6 style="text-align: center;padding-top: 5px;font-weight: bold;">图表分析</h6>
                            <div class="row row-equal">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-block">
                                            <div id="advice2">advice</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
