$(function () {
    ...
    $('#divspider').highcharts({
        ...
        xAxis: {
            categories: ['长期拟合度', '计算速度', '算法直观度', '短期拟合度',
                '学习速度'],
...
function repaintSpiderWeb(id){
	$.getJSON('getscore.jsp',{name:id}, function (data) {
...
function showAnyQuantScore() {
    $("#anyquantscore").slideToggle();
}
